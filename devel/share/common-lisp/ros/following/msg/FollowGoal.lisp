...
(cl:defmethod cl:initialize-instance :after ((m <FollowGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FollowGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name following-msg:<FollowGoal> is deprecated: use following-msg:FollowGoal instead.")))

(cl:ensure-generic-function 'task-val :lambda-list '(m))
(cl:defmethod task-val ((m <FollowGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader following-msg:task-val is deprecated.  Use following-msg:task instead.")
  (task m))
