...
"""autogenerated by genpy from following/FollowActionResult.msg. Do not edit."""
import codecs
import sys
...
class FollowActionResult(genpy.Message):
  ...
  _type = "following/FollowActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','following/FollowResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = following.msg.FollowResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = following.msg.FollowResult()
