...
"""autogenerated by genpy from following/FollowActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class FollowActionFeedback(genpy.Message):
  ...
  _type = "following/FollowActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','following/FollowFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = following.msg.FollowFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = following.msg.FollowFeedback()
