...
"""autogenerated by genpy from bt_follow/FollowAction.msg. Do not edit."""
import codecs
import sys
...
import bt_follow.msg
import genpy
import std_msgs.msg

class FollowAction(genpy.Message):
  _md5sum = "27506295c7e147103cbf303a8febe0fe"
  _type = "bt_follow/FollowAction"
...
"""
  ...
  _slot_types = ['bt_follow/FollowActionGoal','bt_follow/FollowActionResult','bt_follow/FollowActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = bt_follow.msg.FollowActionGoal()
      if self.action_result is None:
        self.action_result = bt_follow.msg.FollowActionResult()
      if self.action_feedback is None:
        self.action_feedback = bt_follow.msg.FollowActionFeedback()
    else:
      self.action_goal = bt_follow.msg.FollowActionGoal()
      self.action_result = bt_follow.msg.FollowActionResult()
      self.action_feedback = bt_follow.msg.FollowActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.task = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.task = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.state = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.progress = str[start:end].decode('utf-8', 'rosmsg')
      else:
