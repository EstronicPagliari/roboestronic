            ...
            if self.got_info is True:
                ...
                while not rospy.is_shutdown():
                    ...
                    if (self.bbox.center.x > 0 and self.bbox.center.x < self.frame_w and self.bbox.center.y > 0 and self.bbox.center.y < self.frame_h):
                        ...
                        if self.lidar_collision.speed_coefficient_setpoint <= 1:
                    ...
                    # check if lidar detected an obstacle
                    ...
                    deceleration_coefficient: float = self.lidar_collision.get_speed_coefficient()
